...
class ActionExecuted(Event):
    ...
    def __str__(self):
        return "ActionExecuted(action: {}, policies: {}, confidence: {})".format(
    ...
    def as_dict(self):
        ...
        d.update({"name": self.action_name, "policies": policy, "confidence": confidence})
        return d
