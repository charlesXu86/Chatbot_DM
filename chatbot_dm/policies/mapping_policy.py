...
class MappingPolicy(Policy):
    ...
    executed whenever the intent is detected. This policies takes precedence over
    any other policies."""

    def __init__(self, priority: int = 3) -> None:
        """Create a new Mapping policies."""
    ...
    def train(
        ...
        **kwargs: Any
        ...
        """Does nothing. This policies is deterministic."""
    ...
    def predict_action_probabilities(
        ...
        the policies will predict zero for every action."""
