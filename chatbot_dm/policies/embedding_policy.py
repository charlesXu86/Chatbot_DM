...
class EmbeddingPolicy(Policy):
    ...
    The policies that is used in our paper https://arxiv.org/abs/1811.11707
    """
    ...
    def train(
        ...
        **kwargs: Any
        ...
        """Train the policies on given training trackers."""

        logger.debug("Started training embedding policies.")
    ...
    def _train_tf(
        ...
        if self.evaluate_on_num_examples:
            logger.info(
                "Finished training embedding policies, "
    ...
    def continue_training(
        ...
        **kwargs: Any
        ...
        """Continue training an already trained policies."""
    ...
    def persist(self, path: Text) -> None:
        """Persists the policies to a storage."""
    ...
    def load(cls, path: Text) -> "EmbeddingPolicy":
        """Loads a policies from the storage.
