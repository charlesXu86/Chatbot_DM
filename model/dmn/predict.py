...
import numpy as np
from model.dmn.data_util import load_data_predict,load_final_test_data,create_voabulary,create_voabulary_label
from tflearn.data_utils import pad_sequences #to_categorical
import os
import codecs
from model.dmn.dmn_model import DynamicMemoryNetwork

#configuration
FLAGS=tf.app.flags.FLAGS
tf.app.flags.DEFINE_integer("num_classes",20,"number of label")
...
tf.app.flags.DEFINE_string("bert_model_path","../zhihu-word2vec-title-desc.bin-100","word2vec's vocabulary and vectors") #zhihu-word2vec.bin-100-->zhihu-word2vec-multilabel-minicount15.bin-100
...
def main(_):
    # 1.load data with vocabulary of words and labels
    vocabulary_word2index, vocabulary_index2word = create_voabulary(bert_model_path=FLAGS.bert_model_path,name_scope="dynamic_memory_network")
