...
# plot_model(Model, file='tmn_model.png', show)


# 超参数配置
data_dir = '/home/xsq/nlp_code/Dialogue_management/data'  # data dir
embedding_fn = '/Data/xiaobensuan/TX50W.vec'    # 预训练好的词向量,用了bert，不需要这个
output_dir = 'output'   # output save dir
TOPIC_NUM = 5           # topic number
...
embedding_mat = utils.load_embedding_dict(embedding_fn)
